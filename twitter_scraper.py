...
def get_twitter_results(query_terms, since_id=None, until_id=None):
    ...
    query_params = {'tweet.fields': 'id,text,created_at,public_metrics', 'expansions': 'author_id', 'user.fields': 'public_metrics', 'max_results': 100}
...
while requests_count < 15:
    ...
    if results_size > 0:
        request_results = process_twitter_results(json_results)
